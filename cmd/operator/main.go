...
import (
	...
	"github.com/AYDEV-FR/dploy/internal/controller"
)
...
func init() {
	...
	utilruntime.Must(dployv1alpha1.AddToScheme(scheme))
	// Flux types: the operator is the only identity that creates these.
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "dploy-operator.dploy.dev",
	})
	if err != nil {
	...
	setupLog.Info("starting dploy operator")
